...
const App = () => {
  ...
  return (
    <main>
      ...
      <div className=" h-[100vh] box-border px-[10%] max-xl:px-[5%] max-lg:px-[1%] max-md:px-[0%] overflow-hidden font-satoshi tracking-wide bg-red-500">
        <Header />
        <div className="h-[88%] mx-[5%] max-xl:mx-[0%]  overflow-hidden no-scrollbar ">
          <Routes>
